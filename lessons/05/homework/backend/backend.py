...
def create_mqtt_receiver(
    ...
    def on_message(client, userdata, message):
        # The userdata field is actually the influx_client
        influx_client = userdata

        topic = message.topic
        payload = json.loads(message.payload.decode())
        logger.info(f"[on_message] Received message: '{payload}' on topic: '{topic}'")

        # TODO 13: Add custom logic here for parsing the payload and writing to InfluxDB
        # TODO 14: Make sure to treat corner cases and possible malformed messages (i.e. invalid topic, missing timestamp, etc.)
...
def main(args: argparse.Namespace):
    ...
    """
    # TODO 7: Configure the logger settings (hint: setup_logger)

    # TODO 8: Create the InfluxDB client
    influx_client = InfluxDBClient(
        # TODO 9: Pass necessary constructor arguments here
    )

    # TODO 10 Create the MQTT receiver
    receiver = create_mqtt_receiver(
        # TODO 11: Pass necessary arguments here
        # What should we pass in userdata? This object is passed as an argument in the on_message callback
        # What would be useful to store in it? (hint: you need to write to InfluxDB when you receive a new message)
    )

    # TODO 12: Subscribe to all possible topics (hint: #)
...
def parse_arguments() -> argparse.Namespace:
    ...
    # TODO 1: Add --mqtt-broker-host argument

    # TODO 2: Add --mqtt-broker-port argument

    # TODO 3: Add --influxdb-host argument
    
    # TODO 4: Add --influxdb-database argument
    
    # TODO 5: Add --influxdb-username argument

    # TODO 6: Add --influxdb-password argument
